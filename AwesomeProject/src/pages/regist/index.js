...
const App = () => {
  ...
  return (
      <ScrollView>
            ...
            <Gap height={24} />
            <TextInput label="Address" placeholder="Masukan alamat anda" value ={Address} onChangeText ={(e)=>setAddres(e)}/>
            <Gap height={24} />
            <TextInput label="Phone Number" placeholder="Masukan nomor hp anda" value ={NumberPhone} onChangeText ={(e)=>setNumberPhone(e)} />
            <Gap height={24} />
